-- Fix incomplete push_subscriptions table by dropping and recreating with proper schema
DROP TABLE IF EXISTS push_subscriptions CASCADE;

-- Create push_subscriptions table for Web Push API with complete schema
