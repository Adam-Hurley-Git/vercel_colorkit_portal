...
export function DashboardFeedbackCard() {
  ...
  const supportEmail = 'adam@calendarcolorkit.com';
      ...
      <CardContent className={'p-0 flex flex-col gap-4'}>
        ...
        <div className="flex flex-col gap-3">
          <Button
            ...
            onClick={() => window.open('https://colorkit.sleekplan.app/', '_blank')}
          >
          ...
          <Button
            ...
            variant={'outline'}
            className={'flex gap-2 text-sm rounded-sm border-border justify-start'}
            onClick={() => window.open('https://bugs-colorkit.sleekplan.app/', '_blank')}
          >
